...
public final class FragmentMyBinding implements ViewBinding {
  ...
  private FragmentMyBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textDashboard) {
  ...
  public static FragmentMyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyBinding((ConstraintLayout) rootView, textDashboard);
    }
