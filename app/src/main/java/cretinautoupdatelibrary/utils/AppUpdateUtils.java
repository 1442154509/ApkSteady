package cretinautoupdatelibrary.utils;
...
import cretinautoupdatelibrary.activity.UpdateBackgroundActivity;
import cretinautoupdatelibrary.activity.UpdateType10Activity;
import cretinautoupdatelibrary.activity.UpdateType11Activity;
import cretinautoupdatelibrary.activity.UpdateType12Activity;
import cretinautoupdatelibrary.activity.UpdateType1Activity;
import cretinautoupdatelibrary.activity.UpdateType2Activity;
import cretinautoupdatelibrary.activity.UpdateType3Activity;
import cretinautoupdatelibrary.activity.UpdateType4Activity;
import cretinautoupdatelibrary.activity.UpdateType5Activity;
import cretinautoupdatelibrary.activity.UpdateType6Activity;
import cretinautoupdatelibrary.activity.UpdateType7Activity;
import cretinautoupdatelibrary.activity.UpdateType8Activity;
import cretinautoupdatelibrary.activity.UpdateType9Activity;
import cretinautoupdatelibrary.interfaces.AppDownloadListener;
import cretinautoupdatelibrary.interfaces.AppUpdateInfoListener;
import cretinautoupdatelibrary.interfaces.MD5CheckListener;
import cretinautoupdatelibrary.model.DownloadInfo;
import cretinautoupdatelibrary.model.LibraryUpdateEntity;
import cretinautoupdatelibrary.model.TypeConfig;
import cretinautoupdatelibrary.model.UpdateConfig;
import cretinautoupdatelibrary.net.HttpCallbackModelListener;
import cretinautoupdatelibrary.net.HttpUtils;
import cretinautoupdatelibrary.service.UpdateReceiver;
...
import static cretinautoupdatelibrary.utils.AppUtils.getAppLocalPath;
...
//        }
        ...
        if(compareversion(info.getProdVersionName(),versionName) != 1){
            listenToUpdateInfo(true);
            clearAllListener();
            return;
        }
